...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header */}
      <header className="bg-gradient-to-r from-primary to-secondary px-4 pt-[env(safe-area-inset-top)]">
        <div className="flex items-center gap-3 py-3 max-w-md mx-auto">
          <button onClick={() => navigate("/")} className="p-2 rounded-xl bg-white/15 text-white">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="font-heading font-extrabold text-white text-lg">TÜcom</h1>
          </div>
        </div>
      </header>
        ...
        <div className="w-full max-w-sm space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {isLogin ? "Ingresa para reportar precios" : "Únete a la comunidad TÜcom"}
            </p>
          </div>
          ...
          <div className="space-y-2.5">
            <Button
              variant="outline"
              className="w-full rounded-xl h-11 gap-3 font-medium"
