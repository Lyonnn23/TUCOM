  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-6">
        ...
        <section className="bg-gradient-primary text-primary-foreground rounded-2xl p-5 shadow-elegant"><h2 className="font-heading font-bold text-xl">Encuentra la bencinera más barata en {commune.displayName} en tiempo real</h2><Link to={`/?tab=stations&commune=${encodeURIComponent(commune.displayName)}`} className="inline-flex mt-3 bg-card text-primary rounded-xl px-4 py-2 text-sm font-bold">Abrir TÜcom →</Link></section>
