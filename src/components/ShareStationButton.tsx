...
import { shareStation, shareViaWhatsApp, type ShareStationPayload } from "@/lib/share";

interface Props {
  payload: ShareStationPayload;
...
const ShareStationButton = ({ payload, variant = "icon", className = "" }: Props) => {
  const handleShare = (e: React.MouseEvent) => {
    e.stopPropagation();
    e.preventDefault();
    shareStation(payload);
  };
